...
!!! example "More complex usage, which can allow you to skip events more efficiently"
    ```
    import midas.file_reader
...
!!! example "Reading ODB information"
    ```
    import midas.file_reader
...
class MidasFile:
    ...
    Attributes:
        file (file-like object): The file we're reading
        event (midas.event.Event): The event we've just read
    ...
    def get_bor_odb_dump(self):
        ...
        Raises:
            RuntimeError: if the dump can't be found.
        """
        self.jump_to_start()
    ...
    def get_next_event_with_bank(self, bank_name):
        ...
        Returns:
            (midas.event.Event): or None of no such event found.
        """
    ...
    def read_next_event(self):
        ...
        Returns:
            (midas.event.Event): or None if no more events left.
        """
    ...
    def read_next_event_header(self):
        ...
        Returns:
            (midas.event.Event): (with only the header populated), or None if no
                more events left.
        """
        self.reset_event()
    ...
    def read_this_event_body(self):
        ...
        Returns:
            (midas.event.Event): with both the header and body populated
        """
...
class Odb:
    ...
    def load_from_json_string(self, json_string):
        """
        Parse the JSON string to populate self.data
