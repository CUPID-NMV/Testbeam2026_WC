...
class EventHeader:
    ...
    Attributes:
        event_id (int): Identifier of which program produced this event
        trigger_mask (int): Sub-identifier if you need to distinguish events
        serial_number (int): Increments during the run
    ...
    def is_midas_internal_event(self):
        ...
        Returns:
            (bool): If this is a special event.
        """
    ...
    def is_msg_event(self):
        ...
        Returns:
            (bool): If this is a message event.
        """
    ...
    def fill_from_struct_pointer(self, event_header_p):
        ...
        Returns:
            (None): The attributes of this object just get filled
        """
    ...
    def fill_from_bytes(self, header_data):
        ...
        Returns:
            (None): But the attributes of this object just get filled
        """
    ...
    def pack(self, buf=None, buf_offset=0):
        ...
        Parameters:
            buf (ctypes.c_char_p): The buffer to write to. Probably best created using
        ...
        Returns:
            (ctypes.c_char_p): The buffer that was written to
        """
...
class Bank:
    """
    Represents a midas BANK, BANK32, or BANK32A struct.
    
    Attributes:
        name (str): 4 characters
        type (int): See `TID_xxx` members in `midas` module
        size_bytes (int):
        data (tuple of int/float/byte etc, or a numpy array if use_numpy is specified when unpacking): The actual data array
    """
    def __init__(self):
        self.name = None
        self.type = None
    ...
    def fill_header_from_bytes(self, bank_header_data, is_bank_32, is_64bit_aligned):
        ...
        Returns:
            (None): Attributes of this object just get filled
        """
...
class Event:
    ...
    def get_bank(self, bank_name):
        ...
        Parameters:
            bank_name (str): Bank to search for
    ...
    def bank_exists(self, bank_name):
        ...
        Returns:
            (bool): Whether this event contains a bank of the given name.
        """
        return bank_name in self.banks

    def fill_header_from_bytes(self, bank_header_data):
        """
        Fill the attributes of this `Event` object (excluding the bank
    ...
    def unpack(self, buf, buf_offset=0, use_numpy=False):
        ...
        Parameters:
            buf (ctypes.c_char_p): The buffer to read from.
            buf_offset (int): Location in the buffer where this event starts.
            use_numpy (bool): Whether to use numpy arrays or regular python tuples for bank data.
        
        Returns:
            (None): self.header and self.banks just get populated
        """
    ...
    def unpack_body(self, buf, buf_offset=0, use_numpy=False):
        ...
        Parameters:
            buf (ctypes.c_char_p): The buffer to read from.
            buf_offset (int): Location in the buffer where the overall bank header data starts.
            use_numpy (bool): Whether to use numpy arrays or regular python tuples for bank data.
        
        Returns:
            (None): self.banks just gets populated
        """
